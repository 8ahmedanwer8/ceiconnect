...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `8ahmedanwer8`, `repo_name`, `https://twitter.com/AhmedAn17381286`, `linkedin_username`, `email_client`, `email`, `CeiConnect`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/8ahmedanwer8/repo_name.git
   ```
...
Your Name - [@https://twitter.com/AhmedAn17381286](https://twitter.com/https://twitter.com/AhmedAn17381286) - email@email_client.com

Project Link: [https://github.com/8ahmedanwer8/repo_name](https://github.com/8ahmedanwer8/repo_name)
